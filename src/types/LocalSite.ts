...
export type LocalSite = {
   ...
   */
  post_upvotes: VoteSettings;
  /**
   * What kind of post downvotes your site allows.
   */
  post_downvotes: VoteSettings;
  /**
   * What kind of comment upvotes your site allows.
   */
  comment_upvotes: VoteSettings;
  /**
   * What kind of comment downvotes your site allows.
   */
  comment_downvotes: VoteSettings;
  /**
  ...
  image_upload_timeout_seconds: number;
  /**
   * These are pixel sizes. Larger images are automatically downscaled.
   */
  image_max_thumbnail_size: number;
  image_max_avatar_size: number;
  image_max_banner_size: number;
  /**
